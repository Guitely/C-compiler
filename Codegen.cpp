...
// 离开当前函数
void Codeen::LeaveCurrentFunction()
{
    current_function = NULL;
}      
...
void Codegen::GenerateCode(AST::Program& program)
{
    ...
    // 新建函数和基本块
    function = llvm::Function::Create(llvm::FunctionType::get(IRBuilder.getVoidTy(), false), llvm::GlobalValue::InternalLinkage, "0Tmp", this->Module);
